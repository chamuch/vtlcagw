...
public class SmResultNotify extends SmppPdu {
	...
	public void decode(byte[] payload) throws SmppCodecException {
		try {
            ...
            this.destinationAddress = CDecimalString.readString(parser); LogService.appLog.debug("Read sourceAddress: " + this.destinationAddress);
            ...
            this.finalState = (Integer) SmppParameter.getInstance(Type.INTEGER, parser.readInt()); LogService.appLog.debug("Read finalState: " + this.finalState);
