...
public class CagwTypeConverter {
  ...
  @Converter
  @FallbackConverter
  public static AuthAcc convertToAuthAcc(String gsonPayload) {
  ...
  @Converter
  @FallbackConverter
  public static AuthAccResponse convertToAuthAccResp(String gsonPayload) {
  ...
  @Converter
  @FallbackConverter
  public static SmResultNotify convertToSmResultNotify(String gsonPayload) {
  ...
  @Converter
  @FallbackConverter
  public static SmResultNotifyResponse convertToSmResultNotifyResp(String gsonPayload) {
  ...
  @Converter
  @FallbackConverter
  public static String convertToJson(AuthAcc pojoPayload) {
  ...
  @Converter
  @FallbackConverter
  public static String convertToJson(AuthAccResponse pojoPayload) {
  ...
  @Converter
  @FallbackConverter
  public static String convertToJson(SmResultNotify pojoPayload) {
  ...
  @Converter
  @FallbackConverter
  public static String convertToJson(SmResultNotifyResponse pojoPayload) {
