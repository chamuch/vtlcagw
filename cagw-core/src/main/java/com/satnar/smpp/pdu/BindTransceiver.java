...
public class BindTransceiver extends SmppPdu {
    ...
    public BindTransceiver() {
        super.setCommandId(CommandId.BIND_TRANSCEIVER);
    ...
    public String toString() {
        return "PDU:: Command Length: " + this.getCommandLength().getValue() + ", " 
                + CommandId.BIND_TRANSCEIVER + "(" + java.lang.Integer.toHexString(CommandId.BIND_TRANSCEIVER.getId())
                ...
                + ", System Type: " + this.systemType.getString()
                + ", Interface Version: " + this.interfaceVersion
                + ", TON: " + this.addressTon
                + ", NPI: " + this.addressNpi
                + ", Address: " + this.addressRange.getString();
    }
